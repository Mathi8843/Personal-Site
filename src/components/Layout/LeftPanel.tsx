      ...
      <div className="h-full rounded-3xl bg-white/10 backdrop-blur-lg backdrop-filter transition-all duration-300 hover:bg-white/15">
        <div className="flex h-full flex-col p-6">
          ...
          <p className="mb-6 text-center text-sm text-white/70">
            ...
            applications. Focused on creating beautiful, performant, and
          ...
          <div className="mb-6 flex justify-center space-x-4">
            ...
            <a
              href="src/components/Sections/Mathivanan.pdf"
              download
              className="rounded-full bg-white/5 p-2.5 text-white/70 transition-all hover:bg-white/10 hover:text-white"
              title="Download CV"
            >
          ...
          {/* Contact Info - Now at the bottom with flex-grow pushing it down */}
          <div className="mt-auto space-y-3 px-4">
            <div className="overflow-hidden rounded-lg bg-white/5 p-3">
              <span className="block text-xs font-medium uppercase text-white/60">
                Location
              </span>
              <span className="mt-1 block text-sm text-white">
                Shenpagapuram, Thenkasi
              </span>
            </div>
            <div className="overflow-hidden rounded-lg bg-white/5 p-3">
              <span className="block text-xs font-medium uppercase text-white/60">
              ...
              <span className="mt-1 block text-sm text-white break-all">
                mathimathi8843@gmail.com
              </span>
            </div>
          </div>
        </div>
